...
export default function HomeScreen() {
  ...
  // Panchkroshi Yatra Boundary - Approximate route based on 5 halt stations
  // This is the outer sacred boundary covering ~88.5 km pilgrimage circuit
  // Includes: Kandawa (S), Bhimachandi (SE), Rameshvara (E), Shivpur (N), Kapiladhara (W)
  // Also includes Durga Kund and other sacred sites within the boundary
  const kasiBoundary = [
    { latitude: 25.2700, longitude: 83.0100 }, // Kandawa area (South) - 1st halt, near BHU
    { latitude: 25.2650, longitude: 83.0400 }, // Bhimachandi area (Southeast) - 2nd halt
    { latitude: 25.2900, longitude: 83.0600 }, // Rameshvara area (East) - 3rd halt, Varana river
    { latitude: 25.3300, longitude: 83.0500 }, // Northeast curve
    { latitude: 25.3620, longitude: 83.0100 }, // Shivpur area (North) - 4th halt
    { latitude: 25.3600, longitude: 82.9800 }, // North-Northwest
    { latitude: 25.3400, longitude: 82.9500 }, // Kapiladhara area (West) - 5th halt
    { latitude: 25.3100, longitude: 82.9400 }, // West-Southwest
    { latitude: 25.2886, longitude: 82.9600 }, // Durga Kund area (Southwest)
    { latitude: 25.2700, longitude: 82.9800 }, // South-Southwest, closing the circuit
  ];
